...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/matplotlib-inline-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12440&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/matplotlib-inline-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `matplotlib-inline` can be installed with:

```
conda install matplotlib-inline
```

It is possible to list all of the versions of `matplotlib-inline` available on your platform with:
